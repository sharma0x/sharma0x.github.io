...
const projectMeta = Object.fromEntries(projectRoutes.map((p) => [p.slug, p]))
...
function ProjectPostContent({ slug }: { slug: string }) {
    ...
    return (
      <div className="flex min-h-svh items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-bold">Failed to load project</h1>
          <p className="mt-2 text-muted-foreground">Could not fetch the project content.</p>
...
export function ProjectPost() {
  ...
  return <ProjectPostContent key={location.pathname} slug={slug} />
}
